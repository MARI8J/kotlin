...
public class Node implements Cloneable {
    ...
    private static class StringNode extends Node {
        ...
        StringNode(int type, String str, CodePosition location) {
            super(type, location);
            if (null == str) {
    ...
    public Node(int nodeType, Node child, CodePosition location) {
        type = nodeType;
        first = last = child;
        child.next = null;
    ...
    public Node(int nodeType, Node child, int operation, CodePosition location) {
        type = nodeType;
        first = last = child;
        child.next = null;
    ...
    public Node(int nodeType, Node left, Node right, CodePosition location) {
        this(nodeType, left, right, -1, location);
    }

    public Node(int nodeType, Node left, Node right, int operation, CodePosition location) {
        type = nodeType;
        first = left;
        last = right;
        left.next = right;
    ...
    public Node(int nodeType, Node left, Node mid, Node right, CodePosition location) {
        type = nodeType;
        first = left;
        last = right;
        left.next = mid;
    ...
    public Node(int nodeType, Node left, Node mid, Node mid2, Node right, CodePosition location) {
        type = nodeType;
        first = left;
        last = right;
        left.next = mid;
    ...
    public Node(int nodeType, CodePosition location) {
        type = nodeType;
        this.location = location;
    }

    public Node(int nodeType, int operation, CodePosition location) {
        type = nodeType;
        this.operation = operation;
        this.location = location;
    }
    ...
    public static Node newString(String str, CodePosition location) {
        return new StringNode(TokenStream.STRING, str, location);
    }

    public static Node newString(int type, String str, CodePosition location) {
        return new StringNode(type, str, location);
    }
